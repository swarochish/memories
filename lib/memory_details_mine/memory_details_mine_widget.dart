...
class MemoryDetailsMineWidget extends StatefulWidget {
  const MemoryDetailsMineWidget({
    Key? key,
    this.campaignId,
  }) : super(key: key);
  ...
  @override
  _MemoryDetailsMineWidgetState createState() =>
      _MemoryDetailsMineWidgetState();
}

class _MemoryDetailsMineWidgetState extends State<MemoryDetailsMineWidget>
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<CampaignRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final memoryDetailsMineCampaignRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
            ...
            title: Text(
              memoryDetailsMineCampaignRecord.campaignName!,
            ...
            child: Column(
              ...
              children: [
                                  ...
                                  child: Stack(
                                    children: [
                                      InkWell(
                                          ...
                                          await Navigator.push(
                                            ...
                                            PageTransition(
                                              ...
                                              child:
                                                ...
                                                image: Image.network(
                                                  memoryDetailsMineCampaignRecord
                                                      .campaignImage!,
                                                  fit: BoxFit.contain,
                                                ),
                                                allowRotation: true,
                                        ...
                                        child: Hero(
                                          tag: memoryDetailsMineCampaignRecord
                                              .campaignImage!,
                                                  ...
                                                  child: Column(
                                                    ...
                                                    crossAxisAlignment:
                                                        CrossAxisAlignment
                                                            .start,
                                                    children: [
                                                      if (memoryDetailsMineCampaignRecord
                                                              .campaignPublished ??
                                                          true)
                                                        StreamBuilder<
                                                            List<
                ...
                Container(
                  ...
                  child: Visibility(
                    visible:
                        !memoryDetailsMineCampaignRecord.campaignPublished!,
                    child: Row(
                      mainAxisSize: MainAxisSize.max,
                        ...
                        Column(
                          ...
                          children: [
                            if (!memoryDetailsMineCampaignRecord
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  final campaignUpdateData =
                                      createCampaignRecordData(
                                    campaignPublished: true,
                                  );
                                  await widget.campaignId!
                ...
                if (memoryDetailsMineCampaignRecord.campaignPublished ?? true)
                  InkWell(
                    onTap: () async {
                      context.pushNamed(
                        'memorywithMoments',
                        queryParams: {
                          'campaignId': serializeParam(
                              widget.campaignId, ParamType.DocumentReference),
                        }.withoutNulls,
                      );
                    },
                    child: Container(
